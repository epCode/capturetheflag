...
local class_props = {
	knight = {
		...
		disallowed_items = {
			"bestguns:assault_rifle",
			"bestguns:bolt_sniper",
		},
	},
	support = {
		name = "Support",
	...
	ranged = {
		name = "Scout",
		color = "orange",
		description = S("Ranged class with a scoped bolt-action rifle and a scaling ladder for reaching high places"),
...
--- Ranged Gun
--
-- The Scout now carries a stock bestguns Bolt Action Rifle (given via the
-- class loadout in init.lua). The old special grenade-launcher rifle has been
-- removed.
